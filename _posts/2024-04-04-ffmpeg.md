...
time=1
ffmpeg -i ${input}.mp4 -strftime ${time} -vframes 1 ${input}_${time}.jpg
```
...
- [FFmpegでよく使う例、コーデックをまとめてみた（2023年版） #ffmpeg - Qiita][1]

[1]:	https://qiita.com/CyberRex/items/960bbd0f348ad8dca544
